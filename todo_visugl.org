...
**** [0/4] TODO sauvegarder les données
***** TODO _periodic_, rdsom
***** TODO _end_, errors
***** TODO _end_, erros on last N points, or on window, or length, or all data
***** TODO _end_, result file hmm_exp, traj_name, dsom, param, test leng, etc...
