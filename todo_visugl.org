...
* [0/1] CURRENT : Independant VisuGL
** TODO Bbox strange dans 001-curve
...
*** Tester avec Figure
* [6/15] Afficher Graphe : OLD classic/legacy OpenGL
...
** TODO update bbox (or not) when adding plotter in Figure
