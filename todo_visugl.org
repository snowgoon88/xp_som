...
* TODO CURRENT : compatibilité avec nouveau visuGL
...
*** Tester avec Figure
* [9/11] Afficher Graphe : OLD classic/legacy OpenGL
** Afficher Grille
...
** Scatter + offset et stride
** Scatter avec variance verticale   
...
=======
** update bbox (or not) when adding plotter in Figure
** Data vs Time Serie
>>>>>>> 1bb8206371e217bb67ac253a8f32817c12070c0d
Actuellement, Curve est implicitement une TimeSerie => un nouveau point n'est accepté par 'add_sample' que si x > xmax.
** séparer données (DataSet, TimeSerie) et Plotter
** DONE Plot dans Figure : par exemple, séparer Img de CmapPlot
#<<Plotfig>>
